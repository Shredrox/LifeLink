          ...
          <nav className='pb-10 flex gap-[7rem]'>
            <section className='w-[30%]'>
              <ul className='w-[100%] flex flex-col gap-4 mt-3'>
                  <li>
                    <Link to='/doctors' className='flex items-center justify-between px-4 h-[4rem] border-2 border-[#456FC7] rounded-md hover:border-white'>
                  ...
                  <li>
                    <Link to='#' className='flex items-center justify-between px-4 h-[4rem] border-2 border-[#456FC7] rounded-md hover:border-white'>
                      <div className='flex gap-3 items-center'>
                ...
                <ul className='mt-5 flex flex-col gap-3 text-[14px]'>
                  <li className='text-[1.25rem]'>
                    <Link to='/about' className='hover:underline'>About LifeLink</Link>
              ...
              <section className='ml-6 w-[25%]'>
                <ul className='mt-2 flex flex-col gap-3 text-[14px]'>
                  <li className='text-[1.25rem]'>
                    <Link to='/doctors' className='hover:underline'>Medical Professionals</Link>
                    <IoIosArrowForward className='inline ml-1' size={20} />
                  </li>
                ...
                <ul className='mt-5 flex flex-col gap-3 text-[14px]'>
                  <li className='text-[1.25rem]'>
                    <Link to='#' className='hover:underline'>Businesses</Link>
                    <IoIosArrowForward className='inline ml-1' size={20} />
                  </li>
                ...
                <ul className='mt-5 flex flex-col gap-3 text-[14px]'>
                  <li className='text-[1.25rem]'>
                    <Link to='#' className='hover:underline'>Hiring</Link>
                    <IoIosArrowForward className='inline ml-1' size={20} />
                  </li>
              ...
              <section className='ml-[5rem] w-[25%]'>
                <ul className='mt-2 flex flex-col gap-3 text-[14px]'>
                  <li className='text-[1.25rem]'>
                    <Link to='#' className='hover:underline'>Researchers</Link>
                    <IoIosArrowForward className='inline ml-1' size={20} />
                  </li>
                ...
                <ul className='mt-5 flex flex-col gap-3 text-[14px]'>
                  <li className='text-[1.25rem]'>
                    <Link to='#' className='hover:underline'>International Patients</Link>
                    <IoIosArrowForward className='inline ml-1' size={20} />
                  </li>
                ...
                <ul className='mt-5 flex flex-col gap-3 text-[14px]'>
                  <li className='text-[1.25rem]'>
                    <Link to='#' className='hover:underline'>Charities</Link>
                    <IoIosArrowForward className='inline ml-1' size={20} />
                  </li>
